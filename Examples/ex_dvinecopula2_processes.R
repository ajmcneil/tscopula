...
mod1 <- dvinecopula2(family = "gauss", pars = list(ar = 0.95, ma = -0.85), maxlag = 30)
mod2 <- dvinecopula2(family = "joe", pars = list(ar = 0.95, ma = -0.85), maxlag = 30)
mod3 <- dvinecopula2(family = "gumbel", pars = list(ar = 0.95, ma = -0.85), maxlag = 30)
mod4 <- dvinecopula2(family = "frank", pars = list(ar = 0.95, ma = -0.85), maxlag = 30)
seed <- 19
set.seed(seed)
data1 <- sim(mod1, 5000)
par(mfrow=c(2,2))
