...
Some preliminary analysis suggests that Frank copulas can work well. The model gives a higher log-likelihood, but has quite a lot of parameters.
...
fit_mix
AIC(fit_Gauss, fit_mix)
```

The following plot shows that the fitted model is able to match the form of the Kendall partial autocorrelation function.
