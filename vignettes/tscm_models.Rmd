...
## 2. VT-D-Vine Process with Skewed Laplace Margin 
...
```{r, fig.show='hold', dev.args =list(pointsize=9)}
plot(tscmfit_full, plottype = "residual")
...
The final plot shows the fitted volatility proxy function.

```{r, fig.show='hold', dev.args =list(pointsize=9)}
plot(tscmfit_full, plottype = "volproxy")
```

## 3. VT-D-Vine Process (type 2) with Skewed Laplace Margin 
